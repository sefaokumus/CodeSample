...
import { ISpacing, ITheme } from './theme.types'
 ...
 *
 */
export interface IBadgeProps extends ISpacing, ViewProps {
  /**
   * id for testID & accesibilityLabel
   */
  id?: string;
 ...
 * Default usage:
 * ```
 * <Chip closable>4</Chip>
 * ```
 *
 */
export interface IChipProps extends ISpacing, ViewProps {
  /**
   * id for testID & accesibilityLabel
   */
  id?: string;
 ...
 */
  outlined?: boolean | string
  /**
 * Renders an close icon
 * @see https://reactnative.dev/docs/view-style-props#backgroundcolor
 */
  closeable?: boolean;
  /**
 * Renders a disabled / non-closable Chip
 */
  disabled?: boolean;
  /**
* Renders a ActivityIndicator inside the Chip
*/
  updating?: boolean;
  /**
   * Close event handler
...
export interface IModalProps extends ModalProps {
  ...
  /**
   * Custom props for modals container
   */
  containerProps? : IBlockProps
}
 ...
 *
 */
export interface ISpinnerProps extends ModalProps {
  /**
   * id for testID & accesibilityLabel
   */
  id?: string;
...
export interface ITextProps extends TextProps, ISpacing {
  ...
  semibold?: boolean;
  /**
 * Renders a Text with predefined fontFamily from theme fonts.extraBold
 * @see https://reactnative.dev/docs/text-style-props#fontfamily
 */
  extraBold?: boolean;
  /**
  ...
  p?: boolean;
  /**
   * Renders a Text with underline decorateion
  ...
  /**
   * Renders the Text Componented with a copy icon that will copy the text to clipboard
   */
  copyable?: boolean;
}
...
export interface IAnimatedToggleProps extends IBlockProps {
  options: { label: string, value: string }[],
  bgColor?: ColorValue,
  color?: ColorValue,
  onToggle: (value: {label:string, value:string}) => void,
}
